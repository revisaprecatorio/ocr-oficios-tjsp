#!/usr/bin/env python3
"""
Script de Ingestão V2.7.1 - Ingest JSONs do outputs_v2_7_1_teste/
Remove 7 campos que foram deletados em V2.7.1
"""
...
def main():
    ...
    print("=" * 80)
    print("📥 INGESTÃO V2.7.1 - outputs_v2_7_1_teste/")
    print("=" * 80)
    ...
    # Query de INSERT V2.7.1 (SEM os 7 campos removidos)
    insert_query = """
    ...
    for json_file in tqdm(json_files, desc="Ingerindo"):
        try:
            ...
            # Log dos campos principais V2.7.1
            print(f"   Requerente: {data.get('requerente_caps', 'N/A')[:40]}")
            ...
            valores = {
                ...
                # V2.7.1: REMOVED process_diagnostico, REMOVED anexo_ii
    ...
    # Resumo
    print(f"\n" + "=" * 80)
    print(f"📊 RESUMO DA INGESTÃO V2.7.1")
    print("=" * 80)
