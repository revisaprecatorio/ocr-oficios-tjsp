...
def main():
    ...
    insert_query = """
        INSERT INTO public.esaj_detalhe_processos (
            ...
            valor_principal_liquido, valor_principal_bruto, juros_moratorios, valor_total_requisitado, saldo_final, data_saldo_final, origem_saldo_final, origem_data_saldo_final,
            ...
            %(valor_principal_liquido)s, %(valor_principal_bruto)s, %(juros_moratorios)s, %(valor_total_requisitado)s, %(saldo_final)s, %(data_saldo_final)s, %(origem_saldo_final)s, %(origem_data_saldo_final)s,
    ...
    update_query = """
        UPDATE public.esaj_detalhe_processos SET
            ...
            data_saldo_final = %(data_saldo_final)s,
            origem_saldo_final = %(origem_saldo_final)s,
            origem_data_saldo_final = %(origem_data_saldo_final)s,
    ...
    for json_file in tqdm(json_files, desc="Ingestão"):
        try:
            ...
            valores = {
                ...
                "data_saldo_final": converter_data(data.get("data_saldo_final")),
