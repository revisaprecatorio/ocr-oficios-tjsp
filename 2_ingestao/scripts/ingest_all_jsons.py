...
def main():
    ...
    insert_query = """
        INSERT INTO public.esaj_detalhe_processos (
            ...
            valor_principal_liquido, valor_principal_bruto, juros_moratorios, valor_total_requisitado, saldo_final, data_saldo_final,
            ...
            %(valor_principal_liquido)s, %(valor_principal_bruto)s, %(juros_moratorios)s, %(valor_total_requisitado)s, %(saldo_final)s, %(data_saldo_final)s,
