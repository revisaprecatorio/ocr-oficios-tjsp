#!/usr/bin/env python3
"""
Script de Ingestão V2.7.4 - Ingest JSONs do outputs_v2_7_4/json/
...
def main():
    ...
    print("=" * 80)
    print("📥 INGESTÃO V2.7.4 - outputs_v2_7_4/json/")
    print("=" * 80)
    ...
    # Query de INSERT V2.7.4 (SEM requerente_caps)
    insert_query = """
    ...
    for json_file in tqdm(json_files, desc="Ingerindo"):
        try:
            ...
            # Log dos campos principais V2.7.4
            ...
            # Preparar valores V2.7.4 (SEM requerente_caps)
            ...
            valores = {
                ...
                # V2.7.4: REMOVED requerente_caps (LLM prompts updated)
    ...
    # Resumo
    print(f"\n" + "=" * 80)
    print(f"📊 RESUMO DA INGESTÃO V2.7.4")
    print("=" * 80)
